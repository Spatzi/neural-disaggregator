...
if IMPORT:
    ...
    rnn.import_model(os.path.join(results_dir, "UKDALE-RNN-['kettle', 'microwave']-40epochs.h5"))  # TODO: insert last model name
else:
    rnn = RNNDisaggregator(train_logfile, val_logfile, learning_rate)

start = time.time()
print("========== TRAIN ============")
epochs = 40  # TODO: update according to the last model if IMPORT = True
for i in range(1):
